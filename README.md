...
<table>
    ...
    <tr>
        ...
        <td>Creación inicial del proyecto y estructura del informe.</td>
    </tr>
    <tr>
        <td>0.1</td>
        <td>21/04/2025</td>
        <td>Equipo de proyecto</td>
        <td>Capítulo I: Introducción (Startup Profile, Solution Profile y Segmentos objetivo).</td>
    </tr>
    <tr>
        <td>0.2</td>
        <td>22/04/2025</td>
        <td>Equipo de proyecto</td>
        <td>Capítulo II: Requirements Elicitation & Analysis (competidores, entrevistas, Needfinding y Ubiquitous Language).</td>
    </tr>
    <tr>
        <td>0.3</td>
        <td>23/04/2025</td>
        <td>Equipo de proyecto</td>
        <td>Capítulo III: Requirements Specification (to-be scenario mapping, user stories, product backlog e impact mapping).</td>
    </tr>
    <tr>
        <td>0.4</td>
        <td>24/04/2025</td>
        <td>Equipo de proyecto</td>
        <td>Capítulo IV: Product Design (style guidelines, arquitectura de información, diseño de landing page, UX/UI de aplicaciones web, prototipos, arquitectura de software, diseño orientado a objetos y diseño de base de datos).</td>
    </tr>
    <tr>
        <td>0.5</td>
        <td>25/04/2025</td>
        <td>Equipo de proyecto</td>
        <td>Capítulo V: Product Implementation (gestión de configuración, implementación y despliegue, colaboración del equipo y video del producto).</td>
    </tr>
    <tr>
        <td>1.0</td>
        <td>27/04/2025</td>
...
![image](https://github.com/user-attachments/assets/5cb94c94-e202-4216-88e2-cad45f40f50f)
...
En el siguiente cuadro se describen las acciones realizadas y los enunciados de conclusiones por parte del grupo, que permiten sustentar el haber alcanzado el logro del ABET - EAC - Student Outcome 4.

| Criterio específico | Acciones realizadas | Conclusiones |
|---|---|---|
| 4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software | Cardenas Minaya, Ricardo Fernando<br><br>AV1: Participó en la definición inicial del alcance funcional de Mecanaut, revisando que la solución no promoviera procesos ambiguos o inseguros para usuarios industriales. Contribuyó a ordenar los requisitos de la plataforma y a mantener trazabilidad entre necesidades del usuario y funcionalidades propuestas.<br><br>TB1: Colaboró en la implementación y evidencia de la plataforma To-Be, aplicando prácticas de control de versiones y documentación técnica. Su participación permitió evidenciar responsabilidad profesional en el desarrollo colaborativo y en la presentación transparente de avances.<br><br>AV2: Participó en la preparación de componentes asociados al ciclo de experimentación y en la revisión del impacto de las funcionalidades implementadas sobre usuarios con diferente nivel de experiencia tecnológica.<br><br>TB2: Desarrolló evidencia de implementación y colaboración en el ciclo To-Be, considerando que las decisiones técnicas debían ser sustentables, verificables y coherentes con el propósito de Mecanaut.<br><br>Agreda Sobrino, Ariana Cecilia<br><br>AV1: Contribuyó en la definición de lineamientos de diseño, arquitectura de información y experiencia de usuario, considerando claridad, consistencia visual y facilidad de uso para usuarios del entorno industrial.<br><br>TB1: Participó en la documentación de interfaces y flujos, manteniendo correspondencia entre las decisiones de diseño y las necesidades de los segmentos objetivo. Esto aportó a una solución más comprensible y menos propensa a errores de uso.<br><br>AV2: Apoyó en la revisión de la experiencia To-Be y en la alineación de los componentes visuales con los objetivos de experimentación, priorizando una interacción clara y responsable.<br><br>TB2: Elaboró evidencia de la plataforma To-Be y contribuyó a mantener una presentación profesional de los artefactos, evitando decisiones visuales que dificulten el acceso o la comprensión del sistema.<br><br>Belledonne Espinoza, Claudia Valeria<br><br>AV1: Participó en la obtención y organización de información del problema, entrevistas y análisis de usuarios, evitando construir la propuesta únicamente desde supuestos del equipo.<br><br>TB1: Contribuyó con validaciones y evidencias de usuario, registrando observaciones relevantes para mejorar la solución. Esta actividad permitió reconocer que el equipo tiene responsabilidad sobre la forma en que la plataforma afecta el trabajo de usuarios reales.<br><br>AV2: Apoyó en la validación de hipótesis y preguntas experimentales, considerando que los resultados debían analizarse con honestidad y sin forzar conclusiones favorables al producto.<br><br>TB2: Desarrolló la sección de entrevistas de validación To-Be, registrando apreciaciones de usuarios y manteniendo una postura profesional frente a hallazgos positivos y negativos.<br><br>Oblitas Davila, Mariano Moises<br><br>AV1: Contribuyó en el análisis técnico y estructuración de secciones del informe relacionadas con requisitos, diseño e implementación, manteniendo coherencia entre el problema, la solución y los artefactos generados.<br><br>TB1: Participó en la revisión de evidencias técnicas y documentación del producto, considerando la importancia de reportar avances reales, trazables y verificables dentro del repositorio del proyecto.<br><br>AV2: Desarrolló la fase de diseño experimental, incluyendo hipótesis, métricas, condiciones, escala, métodos y tracking plan. Esta actividad permitió reconocer la responsabilidad ética de medir antes de concluir y de no tomar decisiones de producto basadas únicamente en preferencias del equipo.<br><br>TB2: Desarrolló el análisis posterior del experimento, interpretando resultados, limitaciones y decisiones de continuidad. Además, contribuyó a la actualización del backlog de preguntas con base en evidencia y no en supuestos.<br><br>Elera Rodríguez, Mauricio Daniel<br><br>AV1: Participó en decisiones de arquitectura, diseño de software y organización técnica, considerando mantenibilidad, consistencia y separación de responsabilidades en la solución.<br><br>TB1: Contribuyó en la configuración técnica, documentación de componentes y prácticas de desarrollo, aplicando responsabilidad profesional sobre la calidad del producto construido.<br><br>AV2: Apoyó en la alineación entre experimentación, implementación y aprendizaje continuo, considerando que el producto debía evolucionar con evidencia recolectada durante el ciclo.<br><br>TB2: Desarrolló la sección de Continuous Learning y los artefactos de shareback, promoviendo una cultura de mejora continua basada en hallazgos, discusión crítica y decisiones documentadas. | Como equipo, se reconoce que la ingeniería de software no consiste únicamente en implementar funcionalidades, sino en construir soluciones responsables, trazables y justificadas. Durante el desarrollo de Mecanaut, se aplicaron prácticas profesionales como control de versiones, documentación progresiva, revisión de evidencias, análisis de usuarios, validación experimental y discusión de impactos.<br><br>El equipo también reconoce la importancia de los principios promovidos por ACM, IEEE Computer Society y el enfoque ético profesional, especialmente en relación con la calidad del producto, la honestidad en la presentación de resultados, la protección del usuario, la accesibilidad y la evaluación de consecuencias del software. |
| 4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales | Cardenas Minaya, Ricardo Fernando<br><br>AV1: Participó en la definición de funcionalidades orientadas a mejorar procesos de mantenimiento industrial, considerando el impacto operativo de reducir desorden, duplicidad de información y fallas de seguimiento.<br><br>TB1: Colaboró en la implementación de evidencia de plataforma, considerando que los productos digitales debían funcionar de manera comprensible para usuarios reales y no solo para el equipo desarrollador.<br><br>AV2: Analizó el impacto de las funcionalidades To-Be sobre usuarios con baja experiencia tecnológica, aportando a decisiones de diseño más inclusivas.<br><br>TB2: Contribuyó a evidenciar cómo la plataforma To-Be puede reducir errores operativos y mejorar la trazabilidad del mantenimiento en empresas industriales.<br><br>Agreda Sobrino, Ariana Cecilia<br><br>AV1: Consideró criterios de accesibilidad, claridad visual y arquitectura de información para reducir barreras de uso en la experiencia web y móvil.<br><br>TB1: Participó en el diseño y documentación de interfaces, evaluando cómo las decisiones visuales podían afectar la comprensión, la productividad y la inclusión de los usuarios.<br><br>AV2: Contribuyó a que la experiencia experimental fuera comprensible y medible, reduciendo el riesgo de obtener datos incorrectos por confusión del usuario.<br><br>TB2: Desarrolló evidencia To-Be con enfoque en consistencia, claridad e inclusión, considerando que una interfaz deficiente puede limitar el acceso a los beneficios del software.<br><br>Belledonne Espinoza, Claudia Valeria<br><br>AV1: Analizó información de usuarios y segmentos objetivo para que el producto respondiera a necesidades reales del contexto industrial.<br><br>TB1: Participó en validaciones y evaluación de experiencia de usuario, identificando oportunidades de mejora con impacto social y operativo.<br><br>AV2: Contribuyó a interpretar hallazgos relacionados con la comprensión de usuarios, evitando conclusiones no sustentadas.<br><br>TB2: Realizó entrevistas To-Be orientadas a evaluar la percepción de usuarios frente a la solución, considerando impactos sociales como facilidad de adopción, reducción de frustración y mejora en el trabajo diario.<br><br>Oblitas Davila, Mariano Moises<br><br>AV1: Participó en la estructuración técnica del informe y en la relación entre requisitos, solución y evidencia, considerando que una documentación incompleta afecta la evaluación profesional del proyecto.<br><br>TB1: Revisó evidencias técnicas de implementación y despliegue, considerando el impacto de decisiones técnicas sobre confiabilidad, operación y mantenimiento futuro.<br><br>AV2: Definió métricas de negocio, medidas, condiciones y escala para evaluar el experimento con criterios objetivos. Esta actividad permitió emitir juicios informados sobre el impacto de una funcionalidad antes de consolidarla como decisión de producto.<br><br>TB2: Analizó los resultados del experimento EC-01, identificando impactos positivos en finalización de tareas, reducción de errores, tiempo de ejecución y claridad del flujo. También reconoció limitaciones de escala para evitar generalizaciones indebidas.<br><br>Elera Rodríguez, Mauricio Daniel<br><br>AV1: Participó en decisiones técnicas asociadas a arquitectura y base de datos, considerando el impacto económico y operativo de construir una solución mantenible.<br><br>TB1: Contribuyó en prácticas de configuración y documentación técnica, favoreciendo sostenibilidad del proyecto y reducción de deuda técnica.<br><br>AV2: Participó en la conexión entre experimentación, pipeline y aprendizaje continuo, considerando que el producto debía mejorar a partir de evidencia.<br><br>TB2: Desarrolló artefactos de aprendizaje continuo y pre-lanzamiento, considerando impactos económicos, sociales y operativos de las decisiones de cierre del proyecto. | Como equipo, se concluye que Mecanaut tiene impacto en varios contextos. En el contexto económico, puede reducir costos asociados a mantenimiento reactivo, errores de planificación y pérdida de trazabilidad. En el contexto social, puede mejorar la organización del trabajo de técnicos y responsables de mantenimiento. En el contexto ambiental, puede contribuir indirectamente a extender la vida útil de equipos industriales mediante mantenimiento preventivo. En el contexto global, exige considerar accesibilidad, internacionalización y protección de datos para operar en empresas de distintos entornos.<br><br>El equipo reconoce que estos impactos no deben asumirse como automáticamente positivos. Por ello, se aplicaron entrevistas, pruebas, análisis experimental y una matriz ética para identificar riesgos, afectados y acciones de mitigación. |
...
<table>
  <tr>
    <td><strong>Who (¿Quién?)</strong></td>
    <td>Empresas con abundantes maquinarias, especialmente aquellas que operan en líneas de producción constantes con alta demanda de mercado, son las principales afectadas por problemas de mantenimiento. El administrador y sus técnicos encargados de estas tareas suelen carecer de herramientas digitales adecuadas.</td>
  </tr>
  <tr>
    <td><strong>What (¿Qué?)</strong></td>
    <td>Se requiere una solución tecnológica que permita gestionar eficientemente los mantenimientos preventivos y correctivos de maquinaria, así como el inventario de repuestos, los costos y personal técnico involucrado.</td>
  </tr>
  <tr>
    <td><strong>Where (¿Dónde?)</strong></td>
    <td>El problema ocurre en fábricas o talleres donde se utilizan diversas maquinarias dentro de líneas de producción. Es común en contextos donde no se cuenta con sistemas integrados o actualizados.</td>
  </tr>
  <tr>
    <td><strong>When (¿Cuándo?)</strong></td>
    <td>El problema se presenta constantemente durante las operaciones diarias, especialmente cuando ocurren fallas imprevistas, durante mantenimientos mal programados o cuando se necesita rastrear el historial de intervenciones.</td>
  </tr>
  <tr>
    <td><strong>Why (¿Por qué?)</strong></td>
    <td>Porque sin un control adecuado del mantenimiento, las empresas sufren pérdidas económicas debido a tiempos de inactividad (downtime), desgaste prematuro de equipos, mala gestión del stock de repuestos, y falta de información para tomar decisiones operativas como la asignación al personal.</td>
  </tr>
  <tr>
    <td><strong>How (¿Cómo?)</strong></td>
    <td>A través del desarrollo de un software llamado <em>Mecanaut</em>, se permitirá registrar activos, programar mantenimientos, monitorear KPIs determinados y administrar el inventario de repuestos, todo en una plataforma web que permita la ejecución de órdenes de trabajo.</td>
  </tr>
  <tr>
    <td><strong>How Much (¿Cuánto?)</strong></td>
    <td>Aunque el costo específico puede variar según la escala de la empresa, se estima que las pérdidas por mal mantenimiento pueden representar hasta un 5-10 % de la producción total anual, lo que justifica la inversión en un sistema automatizado como <em>Mecanaut</em>.</td>
  </tr>
</table>
...
Debe tener una interfaz profesional, clara y sin sobrecarga visual. El sistema debe ser estable, rápido y confiable, incluso con muchos activos registrados en líneas de producción.
<br>

**Business outcomes:**

1. **Creo que mis clientes necesitan** reducir el tiempo de inactividad de sus maquinarias, optimizar sus procesos de mantenimiento y evitar pérdidas económicas debido a fallas imprevistas
2. **Estas necesidades se pueden resolver** con _Mecanaut_ que permite programar, ejecutar y monitorear mantenimientos preventivos, correctivos y predictivos de forma eficiente, guardando un historial de estos.
...
4. **El valor \#1 que un cliente quiere de mi servicio es** la confianza en que el software garantice el correcto seguimiento y ejecución del mantenimiento, evitando pérdidas económicas.
...
<strong> Estrategia 1: Posicionamiento como solución especializada para la industria manufacturera</strong>
...
<strong> Estrategia 2: Diferenciación por simplicidad de uso y adopción inmediata</strong>
...
<strong> Estrategia 3: Aprovechamiento del vacío entre soluciones simples y complejas</strong>
...
\-Algunas tareas que el administrador considera de alta importancia (como _analizar KPIs_) son irrelevantes para el técnico, lo cual refleja su diferencia de enfoque: estratégico vs operativo.
...
<ul>
  <li><strong>Maintenance Request (Solicitud de mantenimiento):</strong> Petición generada por un usuario para atender un incidente o requerimiento de mantenimiento.</li>
  <li><strong>Incident (Incidente):</strong> Evento que interrumpe el funcionamiento normal de un equipo o instalación.</li>
  <li><strong>Work Order (Orden de trabajo):</strong> Documento o registro formal que detalla las tareas a realizar para atender una solicitud de mantenimiento.</li>
  <li><strong>Preventive Maintenance (Mantenimiento preventivo):</strong> Intervenciones programadas para evitar fallas o deterioro de los activos.</li>
  <li><strong>Corrective Maintenance (Mantenimiento correctivo):</strong> Intervenciones realizadas tras detectar una falla o avería.</li>
  <li><strong>Asset (Activo):</strong> Bien físico (máquina, equipo, infraestructura) que requiere mantenimiento o monitoreo.</li>
  <li><strong>Technician (Técnico):</strong> Persona encargada de ejecutar tareas de mantenimiento, reparación o inspección.</li>
  <li><strong>Downtime (Tiempo de inactividad):</strong> Tiempo durante el cual un activo no está operativo debido a un problema técnico.</li>
  <li><strong>Maintenance Schedule (Cronograma de mantenimiento):</strong> Plan que define fechas y frecuencias para realizar tareas de mantenimiento.</li>
  <li><strong>Mean Time Between Failures (MTBF):</strong> El tiempo promedio entre fallos de un equipo. Este valor es importante para evaluar la confiabilidad de las máquinas y para planificar el mantenimiento preventivo.</li>
  <li><strong>Mean Time To Repair (MTTR):</strong> El tiempo promedio necesario para reparar un equipo después de una falla. Este valor es crucial para evaluar la eficiencia del proceso de reparación y la capacidad de recuperación.</li>
  <li><strong>Spare Parts (Repuestos):</strong> Componentes o piezas necesarias para reparar o reemplazar partes de un activo.</li>
  <li><strong>Checklist (Lista de verificación):</strong> Documento que contiene tareas o ítems que deben revisarse durante una intervención.</li>
  <li><strong>Report (Informe):</strong> Documento que resume el trabajo realizado, hallazgos o resultados de una tarea de mantenimiento.</li>
  <li><strong>Ticket:</strong> Registro en el sistema sobre un problema específico reportado.</li>
  <li><strong>Maintenance History (Historial de mantenimiento):</strong> Registro acumulado de todas las intervenciones realizadas sobre un activo.</li>
  <li><strong>Service Provider (Proveedor de servicios):</strong> Empresa o profesional externo encargado de brindar servicios de mantenimiento.</li>
</ul>
...
Después de comprender a profundidad a nuestros usuarios y sus contextos, pasamos a una etapa clave del proyecto: definir claramente qué debe hacer nuestra solución. En esta sección presentamos los requisitos que guiarán el desarrollo del producto digital, alineados con los hallazgos obtenidos. A través de herramientas como el _To-Be Scenario Mapping_, _User Stories_, _Impact Map_ y _Product Backlog_, comenzamos a construir la base de una experiencia que responda verdaderamente a sus necesidades.
...
**Security Context**<br>
**Account**<br>
**Descripción**: Organización cliente suscrita a la plataforma, con límites de usuarios y activos definidos por su plan.<br>
...
**User**<br>
**Descripción**: Persona que accede al sistema en nombre de una cuenta.<br>
...
**Role**<br>
**Descripción**: Conjunto de permisos asignado a usuarios.<br>
...
**Permission**<br>
**Descripción**: Permiso atómico para control de acceso.<br>
...
**MenuItem**<br>
**Descripción**: Opción de menú visible según permisos.<br>
...
**Asset**<br>
**Descripción**: Maquinaria o equipo registrado en planta.<br>
...
**SparePart**<br>
**Descripción**: Repuesto utilizable por los activos.<br>
...
**Enum**<br>  
`AssetStatus { ACTIVE, INACTIVE, MAINTENANCE }`<br>
...
**MaintenancePlan**<br>
**Descripción**: Definición de mantenimiento periódico.<br>
...
**MaintenanceTask**<br>
**Descripción**: Tarea derivada de un plan.<br>
...
**ScheduleSlot**<br>
**Descripción**: Franja de calendario disponible.<br>
...
**Enum**<br>  
`Frequency { DAILY, WEEKLY, MONTHLY, USAGE }`<br>
...
**WorkOrder**<br>
**Descripción**: Orden de trabajo derivada de una tarea planificada.<br>
...
**WorkOrderLine**<br>
**Descripción**: Detalle o paso de una orden.<br>
...
**Evidence**<br>
**Descripción**: Evidencia (foto/firma) de ejecución.<br>
...
**Enum**<br>  
`WorkOrderStatus { OPEN, IN_PROGRESS, CLOSED }`<br>
...
**SensorReading**<br>
**Descripción**: Medición obtenida de un sensor IoT.<br>
...
**AnalysisResult**<br>
**Descripción**: Resultado del análisis predictivo.<br>
...
**Descripción**: Plantilla para comunicaciones.<br>
...
| `body`    | `String` | `private`   | Texto con _placeholders_ |
...
**Notification**<br>
**Descripción**: Notificación enviada al usuario.<br>
...
**Enum**<br>  
`NotificationStatus { PENDING, SENT, FAILED }`<br>
...
**Subscription**<br>
**Descripción**: Suscripción del cliente.<br>
...
**Payment**<br>
**Descripción**: Pago realizado por el usuario.<br>
...
**Enum**<br>  
`PlanType { BASIC, PRO, ENTERPRISE }`<br>
...
**NotificationTemplate**<br>
**Descripción**: Plantilla para notificaciones.<br>
...
**Notification**<br>
**Descripción**: Notificación enviada o pendiente.<br>
...
**Subscription**<br>
**Descripción**: Suscripción activa del cliente.<br>
...
**Invoice**<br>
**Descripción**: Factura generada tras el servicio.<br>
...
**Payment**<br>
**Descripción**: Registro de pago realizado por el cliente.<br>
...
<p><strong>Pivotal Tracker:</strong> Herramienta de seguimiento ágil donde las historias de usuario se registran, priorizan y evolucionan en un backlog inteligente que mide el ritmo de desarrollo (velocity) y ayuda a predecir releases con mayor precisión. <a href="https://www.pivotaltracker.com/">https://www.pivotaltracker.com/</a></p>
<p><strong>Miro:</strong> Lienzo colaborativo online perfecto para mapear empatía, delinear user-flows y construir diagramas de alto impacto visual. Favorece la cocreación en tiempo real entre diseñadores, analistas y stakeholders. <a href="https://miro.com/signup">https://miro.com/signup</a></p>
<br>
...
<p><strong>WebStorm:</strong> IDE especializado para ecosistemas Vue.js, Angular, JavaScript, CSS y HTML, con autocompletado inteligente, depuración avanzada y refactorizaciones seguras que aceleran la productividad del front-end. <a href="https://www.jetbrains.com/webstorm/download/">https://www.jetbrains.com/webstorm/download/</a></p>
...
<p><strong>Java Development Kit (JDK 11+):</strong> Kit esencial para compilar y ejecutar aplicaciones Spring Boot con soporte a las últimas características del lenguaje.</p>
...
<br>
<p><strong>Angular CLI:</strong> Utilidad de línea de comandos que genera scaffolding, ejecuta servidores de desarrollo (ng serve) y produce builds optimizados (ng build) con un solo comando. Instalación: npm install -g @angular/cli <a href="https://angular.io/cli">https://angular.io/cli</a></p>
<p><strong>Angular:</strong> Framework full-stack para SPAs que combina componentes declarativos, enrutamiento integrado y data-binding reactivo, ofreciendo una base sólida para aplicaciones de gran escala. <a href="https://angular.io/">https://angular.io/</a></p>
...
<p><strong>Azure CLI:</strong> Cliente de línea de comandos todo-en-uno que te permite orquestar despliegues, aprovisionar y gestionar cualquier recurso de Azure mediante scripts automatizados, alias personalizados y perfiles de autenticación. <a href="https://docs.microsoft.com/cli/azure/install-azure-cli">https://docs.microsoft.com/cli/azure/install-azure-cli</a></p>
<p><strong>Azure Resources:</strong> Portal centralizado y panel de control intuitivo donde se exhiben todos tus servicios en la nube, permitiendo crear, configurar y escalar infraestructura con unos pocos clics. <a href="https://portal.azure.com/">https://portal.azure.com/</a></p>
<p><strong>Azure App Service (Web Service):</strong> Servicio PaaS que aloja tu API ASP.NET Core con despliegues automáticos desde GitHub o Azure DevOps, autoescalado configurable, certificados SSL integrados y diagnósticos en tiempo real.</p>
<p><strong>Azure Static Web Apps:</strong> Plataforma especializada en sitios estáticos y SPAs que combina CDN global de baja latencia, integración nativa con repositorios Git y funciones serverless ligeras (Azure Functions). Facilita la publicación instantánea de tu landing page. </p>
<p><strong>Azure SQL Database:</strong> Motor de base de datos relacional en la nube con elasticidad bajo demanda, replicación geo-redundante, backups automáticos y seguridad avanzada. </p>
<br>
...
<p>Nuestro proyecto se regirá por el elegante tejido de ramas que propone GitFlow, garantizando un desarrollo organizado, colaborativo y predecible, mientras GitHub actúa como el custodio de nuestro código y el escenario donde converge cada contribución.</p>
...
<p>Antes de empezar a desplegar, asegúrate de tener todo en orden. Una base sólida evitará sustos cuando el pipeline empiece a crear recursos en la nube.</p>
...
<p>Centralizar todos los servicios en un solo Resource Group simplifica la vida: podrás aplicar reglas de CORS, etiquetas de coste y políticas de seguridad una sola vez, además de agilizar la limpieza cuando termine el ciclo de pruebas.</p>
...
<p><em>Aquí es donde crearemos cada uno de los recursos necesarios.</em></p>
...
En esta sección se presentan las pruebas unitarias desarrolladas para validar el correcto funcionamiento de las entidades y modelos principales que conforman el Core Domain de Mecanaut. El objetivo es asegurar que la lógica de negocio y las reglas internas operen adecuadamente de forma aislada, sin depender de bases de datos ni servicios externos. Utilizando el framework de pruebas xUnit en conjunto con Moq, se comprobó la precisión y estabilidad de cada componente individual ante distintos escenarios. A continuación, se detallan las pruebas realizadas:
...
<img src="img/testing/unit-US23-1.png"></img>

| Prueba Unitaria 2                                       |
| ------------------------------------------------------- |
| US23: Registro de métricas y evaluación de umbrales     |
| Escenario 1: Valor supera el umbral máximo de seguridad |

<img src="img/testing/unit-US23-2.png"></img>
...
<img src="img/testing/unit-US31-1.png"></img>
...
<img src="img/testing/unit-US31-2.png"></img>
...
<img src="img/testing/unit-US09-1.png"></img>
...
<img src="img/testing/unit-US18-1.png"></img>
...
<img src="img/testing/unit-US18-2.png"></img>

**Evidencia de testing:**
<img src="img/testing/unit.png"></img>

### 6.1.2. Core Integration Tests.

En esta sección se detallan las pruebas de integración realizadas para asegurar que los diferentes módulos y componentes de Mecanaut funcionen de manera coordinada al interactuar entre sí[cite: 883]. Estas pruebas abarcan flujos completos de información, validando desde la comunicación bidireccional entre el cliente (Frontend) y el servidor (Backend), hasta la correcta interacción entre los servicios de aplicación y la persistencia de datos.

Para validar el Backend en .NET, se empleó `WebApplicationFactory` interactuando con una base de datos en memoria, simulando peticiones HTTP reales. Simultáneamente, para el Frontend en Vue.js, se utilizó Vitest junto con Vue Test Utils y un simulador de peticiones HTTP para confirmar que las interfaces empaqueten correctamente la información y respondan adecuadamente a los códigos de estado del servidor.

| Elemento                | Descripción                                                                                                                                                                                                                                                                                                                                                                                      |
| :---------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Clase de Test**       | `MecanautIntegrationTests`                                                                                                                                                                                                                                                                                                                                                                       |
| **Módulo(s)**           | AssetManagement, WorkOrders, DynamicMaintenancePlanning, InventoryManagement, IAM - US01, US04, US09, US18, US31                                                                                                                                                                                                                                                                                 |
| **Descripción General** | Validar la integración completa de los flujos operativos críticos dentro del sistema Mecanaut, comprobando que las operaciones relacionadas con la gestión de activos, asignación de personal, planificación y ejecución de mantenimiento funcionen correctamente desde la capa HTTP hasta la persistencia en la base de datos _InMemory_, así como la respuesta y renderizado en el cliente web |
...
| Escenario 4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **User Story:** US18 y US31 - Cierre de Orden e Impacto en Inventario                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Descripción:** Este escenario de alta complejidad técnica valida el cruce de información entre diferentes _Bounded Contexts_. Se inyecta un repuesto de inventario inicial (50 unidades) y luego se simula el cierre operativo de una orden de trabajo que consumió 2 de esos repuestos. La prueba verifica de manera integral que la solicitud HTTP finalice con estado exitoso y, sobre todo, que el sistema sea capaz de (1) cambiar el estado del `WorkOrder` a "Completed" y (2) comunicarse asíncronamente con el módulo de _InventoryManagement_ para descontar el `CurrentStock` del repuesto. Es la prueba definitiva de la interoperabilidad del núcleo de negocio. |
| <img src="img/testing/integrationtest4.png" alt="Evidencia Test Integración US18 y US31">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |

<br>

**Evidencia de testing Backend:**
...
<img src="img/testing/integrationtestevidence1.png" alt="Evidencia Testing">

### 6.1.3. Core Behavior-Driven Development

En esta sección se documenta la aplicación de técnicas de Behavior-Driven Development (BDD) para definir y validar el comportamiento del sistema directamente desde la perspectiva del usuario final. Mediante el uso del framework SpecFlow y el lenguaje Gherkin, se estructuraron pruebas automatizadas basadas en las User Stories US04, US09, US18, US23 y US31, pertenecientes a los módulos _Core_ de gestión de activos, planificación de mantenimiento e inventario. Estas historias fueron seleccionadas porque representan flujos operativos centrales solicitados por los administradores y técnicos. Los escenarios evaluados son los siguientes:

| Escenario 1                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **User Story:** US18 y US31 - Ejecución de orden y descuento de stock                                                                                                                                                                                                                                                                                                                                                                                          |
| Este _feature_ documenta y valida el flujo de trabajo de un técnico operativo al finalizar una tarea. Verifica que el sistema registre exitosamente la orden como completada y, de manera simultánea, actualice de forma precisa el inventario deduciendo los repuestos utilizados. Además, contempla el escenario negativo donde se intenta registrar un uso de stock superior al disponible, asegurando la robustez de las reglas de negocio del inventario. |
| <img src="img/testing/bddtest1.png" alt="Evidencia BDD US18 y US31">                                                                                                                                                                                                                                                                                                                                                                                           |

<br>

| Escenario 2                                                                                                                                                                                                                                                                                                                                                                                                                             |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **User Story:** US23 - Registro de Métricas de Maquinarias y Alertas                                                                                                                                                                                                                                                                                                                                                                    |
| Este _feature_ prueba el comportamiento del sistema de monitoreo de condición operativa. Valida que, cuando una maquinaria registra una lectura (como temperatura) que excede el límite de seguridad establecido, el sistema reaccione automáticamente cambiando el estado del activo a mantenimiento requerido. También confirma que la inyección de valores seguros mantenga el estado de la máquina como operativa sin alteraciones. |
| <img src="img/testing/bddtest2.png" alt="Evidencia BDD US23">                                                                                                                                                                                                                                                                                                                                                                           |

<br>

| Escenario 3                                                                                                                                                                                                                                                                                                                                                                                                                             |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **User Story:** US09 - Creación de plan de mantenimiento dinámico                                                                                                                                                                                                                                                                                                                                                                       |
| Este _feature_ aborda la perspectiva del administrador al planificar el mantenimiento a largo plazo para una línea de producción. Verifica que al proporcionar los datos completos y válidos, el sistema procese y agregue el plan al calendario correctamente. Asimismo, valida el comportamiento defensivo del sistema frente a envíos incompletos, asegurando que se solicite la información obligatoria faltante antes de proceder. |
| <img src="img/testing/bddtest3.png" alt="Evidencia BDD US09">                                                                                                                                                                                                                                                                                                                                                                           |

<br>

| Escenario 4                                                                                                                                                                                                                                                                                                                                                                                                                 |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **User Story:** US04 - Asignación de personal técnico a órdenes de trabajo                                                                                                                                                                                                                                                                                                                                                  |
| Este _feature_ valida el flujo de distribución de carga laboral en las tareas de mantenimiento. Comprueba que la administradora pueda asignar exitosamente a un técnico disponible a una orden abierta. Adicionalmente, incluye la regla de negocio que previene la sobrecarga, verificando que el sistema notifique y alerte si se intenta asignar una nueva tarea a un técnico que presenta conflictos de disponibilidad. |
| <img src="img/testing/bddtest4.png" alt="Evidencia BDD US04">                                                                                                                                                                                                                                                                                                                                                               |

**Evidencia de testing:**

<img src="img/testing/bddtestevidence.png" alt="Evidencia Testing">

### 6.1.4. Core System Tests.

En esta sección se exponen las pruebas de sistema (End-to-End o E2E) ejecutadas para comprobar que la aplicación funciona correctamente en su totalidad dentro del entorno web. Estas pruebas validan el flujo completo y real del sistema, cubriendo la navegación, el llenado de formularios interactivos, la comunicación del frontend con el backend y las actualizaciones visuales de la interfaz.

Para lograr esto, se utilizó el framework de automatización **Cypress**, el cual simuló la interacción de usuarios reales bajo los dos flujos operativos más críticos para el negocio: el mantenimiento correctivo manual y el mantenimiento preventivo automatizado.

**Escenarios de Prueba E2E**

| Escenario E2E 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Flujo:** Flujo Operativo Crítico Completo (Orden Correctiva)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Descripción:** Este escenario simula el ciclo de vida completo de un mantenimiento correctivo interactuando con dos roles distintos. Primero, valida que un Administrador pueda iniciar sesión, navegar por el sistema, registrar una nueva orden de trabajo con tareas específicas y asignarla a un técnico. En la segunda fase, simula el ingreso del Técnico asignado, quien navega a su panel de ejecución, selecciona la orden, marca las tareas como realizadas, añade observaciones y finaliza la operación, verificando que la orden desaparezca de la bandeja de pendientes. |

| **Código de la Prueba:**<br><br>
<img src="img/testing/e2e_correctivo_codigo.png" alt="Código Cypress Flujo Correctivo"> |
| **Ejecución de la Prueba:**<br> https://youtu.be/wbL8JKoExGw
<br> <img src="img/testing/e2e_correctivo_ejecucion.png" alt="Ejecución Cypress Flujo Correctivo"> |

<br>

| Escenario E2E 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Flujo:** Flujo de Plan de Mantenimiento Preventivo (Automatizado)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Descripción:** Este escenario evalúa la capacidad de automatización y prevención del sistema interactuando con múltiples módulos. El robot simula a un Administrador que registra una maquinaria nueva y le configura un plan de mantenimiento dinámico asociado a un parámetro específico (ej. desgaste por uso). Posteriormente, el sistema simula el ingreso de una nueva lectura de la métrica de esa maquinaria que supera el límite preventivo. Finalmente, la prueba navega a la bandeja de órdenes de trabajo para validar visualmente que el motor de reglas de Mecanaut haya autogenerado la orden de trabajo preventiva con éxito. |

| **Código de la Prueba:**<br><br>
<img src="img/testing/e2e_preventivo_codigo.png" alt="Código Cypress Flujo Preventivo"> |
| **Ejecución de la Prueba:**<br> https://youtu.be/dM6B7RClbws<br>
<img src="img/testing/e2e_preventivo_ejecucion.png" alt="Ejecución Cypress Flujo Preventivo"> |

<br>

<br>

| Escenario E2E 3 (Entorno Móvil)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
**Imagen:**  
<img width="1918" height="922" alt="image" src="https://github.com/user-attachments/assets/a99b196e-c898-4d14-9d38-4a4a406e47f9" />
...
**Imagen:**  
<img width="1914" height="906" alt="image" src="https://github.com/user-attachments/assets/e8c9ba0d-0237-4f13-abb1-3a5555629667" />
