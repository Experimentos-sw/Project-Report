...
En esta sección se detallan las pruebas de integración realizadas para validar la correcta comunicación e interacción entre los componentes principales de Mecanaut. Estas pruebas garantizan el funcionamiento coordinado y consistente de los distintos módulos del sistema, abarcando el flujo desde la recepción de la petición HTTP en los controladores hasta la persistencia en la base de datos. Utilizando la herramienta WebApplicationFactory con una base de datos en memoria, se evaluó la integración de los siguientes servicios:
...
| **Descripción General** | Validar la integración completa de los flujos operativos críticos dentro del sistema Mecanaut, comprobando que las operaciones relacionadas con la gestión de activos, asignación de personal, planificación y ejecución de mantenimiento funcionen correctamente desde la capa HTTP hasta la persistencia en la base de datos _InMemory_. |
